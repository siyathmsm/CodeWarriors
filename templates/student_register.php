...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO register_student (firstname, lastname, username, email, phoneno, password, activation_token) VALUES ('$firstname', '$lastname', '$username', '$email', '$phoneno', '$password', '$token')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        try {
            ...
            $activation_link = "http://localhost/CodeWarriors/templates/activate_student.php?token=$token"; // Replace with your activation script URL
